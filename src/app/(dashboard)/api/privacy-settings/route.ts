...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!prisma.settings) {
      console.error('prisma.settings is undefined. Did you run prisma generate?');
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (body.onlineStatus !== undefined) updateData.onlineStatusVisible = body.onlineStatus;
    ...
    if (body.showCountry !== undefined) updateData.countryVisible = body.showCountry;
    if (body.syncEmails !== undefined) updateData.syncEmails = body.syncEmails;
    if (body.allowSearch !== undefined) updateData.allowSearch = body.allowSearch;
