...
export const aboutMetadata: Metadata = {
  ...
  description: 'Meet the team behind HyperChat and learn about our mission to transform digital communication with AI-powered realtime chat technology.',
  keywords: [
    'about HyperChat',
    'company story',
    'mission vision',
  ...
  alternates: {
    canonical: 'https://hyper-chat.vercel.app/about'
  },
