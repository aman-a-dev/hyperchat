        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <Card className="border-border bg-card p-6 md:p-8">
              <h3 className="flex mb-4 text-xl font-semibold text-foreground">
                <span>Meet Developer</span>
              </h3>
              <div className="space-y-3 text-muted-foreground">
                <div className="flex flex-col">
                  <span className="font-black text-md">Amanuel Anteneh</span>
                  <span className="font-medium">Full Stack Web Developer</span>
                </div>
                <p className="text-muted-foreground">
                  I am a Full Stack Web Developer who creat high-quality digital
                  awesome websites.
                </p>
                <a
                  target="_blank"
                  href="https://amanadev.vercel.app/"
                  className="underline underline-offset-2 underline-primary"
                  rel="noopener"
                >
                  Portfolio
                </a>
