...
const timelineData = [
   {
      ...
      description: "Create Account with username, email (with Google or manually) password or login.",
   ...
   return (
      <div className='flex flex-col overflow-x-hidden pt-3'>
         <motion.h1
            ...
            className={`${starborn.className} text-center text-4xl font-extrabold tracking-tight text-balance  md:text-5xl`}
         >
            Quick Start
         </motion.h1>
