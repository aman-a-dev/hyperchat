  ...
  if (loading) {
    return (
      <div className="h-full w-full mb-16 space-y-2 p-4">
        ...
        <SmoothTab items={[{ id: 'all', title: 'All' }]} value="all" onChange={() => {}} />
      </div>
    );
  }
    ...
    <div className="h-full w-full mb-16 relative">
      ...
      {showDebug && (
        <div className="fixed inset-0 z-40 bg-background/95 p-4 overflow-auto">
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div>
              <h4 className="font-semibold">Parsed Conversations ({conversations.length}):</h4>
              <pre className="bg-muted p-2 rounded text-xs overflow-auto max-h-40">
            ...
            <div>
              <h4 className="font-semibold">Mapped User Items ({userItems.length}):</h4>
              <pre className="bg-muted p-2 rounded text-xs overflow-auto max-h-40">
      ...
      {userItems.length === 0 ? (
        <div className="h-[90vh] flex flex-col items-center justify-center">
          ...
          <p className="text-muted-foreground mb-4">This category doesn't contain any users.</p>
