        ...
        <div className="flex flex-1 items-center gap-3 overflow-hidden pl-2">
          ...
          >
            <ItemMedia>
              <div className="relative">
                <Avatar className="w-13 h-13 rounded-md mb-2">
                  <AvatarImage alt={name} src={avatar} className="rounded-[30%/30%]" />
            ...
            <ItemContent>
              ...
              <ItemDescription className="truncate text-sm">{email}</ItemDescription>
              <p className="text-xs text-muted-foreground whitespace-nowrap">{lastMsg && `■ ${lastMsg}`}</p>
            </ItemContent>
          </Link>
        </div>
        ...
        {!isSelecting && (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuLabel className="text-muted-foreground text-xs md:text-base">User Options</DropdownMenuLabel>
